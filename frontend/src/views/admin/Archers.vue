...
import type { Archer } from '@/models/archer'
import {
  EyeIcon,
  HashtagIcon,
  MagnifyingGlassIcon,
  ...
  <Modal v-model="showModal" title="Add new archer">
    ...
    <template #footer>
      <div class="wf-full flex justify-between items-center gap-4">
        <button
          class="w-1/2 flex items-center justify-center gap-4 px-4 py-2 text-white bg-blue-700 rounded hover:bg-blue-800 hover:cursor-pointer"
          @click="
            () => {
        ...
        <button
          class="w-1/2 px-4 py-2 mr-2 text-gray-900 bg-white border border-gray-200 rounded hover:bg-gray-100 hover:cursor-pointer hover:text-blue-700"
